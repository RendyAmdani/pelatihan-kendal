<section class="content-header">
    <h1>
        Template DPCP pensiun<small></small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="{!!url('')!!}"> Dashboard</a></li>
        <li class="active">Template DPCP pensiun</li>
    </ol>
</section>
        ...
        <div class="box-header with-border row">
            <div class="col-md-12">
                <ul class="nav nav-tabs tab1" id="myTab">
                    <li class="active"><a href="{!!url('')!!}/epensiun/templateskpensiun/dpcp"> <i class="fa fa-fw fa-list-ul"></i> DPCP</a></li>
                ...
                <div class="tab-pane active"><br>
                    ...
                    <div class="box-body">
                        ...
                        <input type="hidden" name="jenis" class="jenis" id="jenis" value="2">
                        <div class="form-group">
                            {!! Form::label('template', 'Template:', array('class' => 'col-sm-2 control-label')) !!}
                            <div class="col-sm-10">
                                <textarea rows="10" cols="600" name="template" class="ckeditor form-control" id="template" placeholder="Template DPCP">
                                    <?php
                                    $cek = TemplateskpensiunModel::getTemplate(session('idskpd'), 2);
                                    if($cek != 0){
                                        echo TemplateskpensiunModel::getTemplate(session('idskpd'), 2);
                                    }else{
                                        echo  TemplateskpensiunModel::getTemplate('all', 2);
                                    }
                                    ?>
                                </textarea>
                            </div>
